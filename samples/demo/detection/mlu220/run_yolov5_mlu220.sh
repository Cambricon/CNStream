...
MODEL_PATH=$CURRENT_FILE/../../../../data/models/MLU220/yolov5/
MODEL_NAME=yolov5_4c4b_rgb_220.cambricon
mkdir -p $MODEL_PATH

cd $MODEL_PATH
    if [ ! -f "${MODEL_NAME}" ]; then
      wget -O ${MODEL_NAME} http://video.cambricon.com/models/MLU220/yolov5/${MODEL_NAME}
