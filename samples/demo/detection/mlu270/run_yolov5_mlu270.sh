...
MODEL_PATH=$CURRENT_FILE/../../../../data/models/MLU270/yolov5/
MODEL_NAME=yolov5_4c4b_rgb_270.cambricon
mkdir -p $MODEL_PATH

cd $MODEL_PATH
    if [ ! -f "${MODEL_NAME}" ]; then
      wget -O ${MODEL_NAME} http://video.cambricon.com/models/MLU270/yolov5/${MODEL_NAME}
...
${SAMPLES_DIR}/bin/demo  \
    ...
    --wait_time 0 \
    --loop=false \
    --config_fname "$CURRENT_FILE/yolov5_mlu270_config.json" \
    --log_to_stderr=true
